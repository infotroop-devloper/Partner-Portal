...
?>
<div id="kt_header" class="header" style="background:  linear-gradient(to right, #fff, rgb(150 185 243));" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-animation="false" data-kt-sticky-offset="{default: '200px', lg: '300px'}" style="top: 0px;" data-kt-sticky-enabled="true">
    <div class="container-fluid d-flex align-items-center flex-lg-stack" >
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-2 me-lg-5">
            <div class="flex-grow-1" style="padding-right:10px;">
                <a href="#">
                    <img alt="Logo" src="<?php echo BASE_URL;?>assets\media\logos\InfoTroopLogo.png" style="width: 250px;">
                </a>
            </div>
            <div class="flex-grow-1" style="padding-left:10px;">
                <!-- <h3 style="color:white;font-weight:bold;margin-bottom: 0px;margin-top: 18px;">Subscription Plans</h3> -->
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="padding-top: 10px;">
            ...
            <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl" style="margin: 0px 10px;max-width: none;">
                ...
                <div class="content flex-row-fluid" id="kt_content">
                    <section class="banner-img container-fluid" style="background-image: url('assets/media/img/banner-image3.jpg'); 
                                ...
                                <table class="table align-middle table-striped gy-7" id="example">
                                        ...
                                        <tr id="kt_pricing">
                                            ...
                                            <th class="text-center ">
                                                <div class=" py-12 mb-15" style="width: 220px !important;">
                                                    ...
                                                    <br/>
                                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select..." name="basic" id="basic" onChange="fnBasicBtn();">
                                                        <option value=""></option>
                                                    ...
                                                    <br/>
                                                    <br/>
                                                    <a class="btn btn-light-primary fw-bold mx-auto" id="basic_btn">Buy Now</a>
                                                </div>
                                            </th>
                                            <script>
                                                function fnBasicBtn(){
                                                    ...
                                                    if(basic=="1"){
                                                        document.getElementById("basic_btn").innerHTML = 'Buy Now at ₹4,999.00/-';
                                                        document.getElementById("basic_btn").href = 'https://subscriptions.infotroop.co.in/subscribe/a86d909731e0295c6c23ab887fa1937f71c07f8e18f84a4f0823bcb88ecfdc2b/ITISPL-ATS-BSC-1Y';
                                                    }else if(basic=="3"){
                                                        document.getElementById("basic_btn").innerHTML = 'Buy Now at ₹9,999.00/-';
                                                        document.getElementById("basic_btn").href = 'https://subscriptions.infotroop.co.in/subscribe/a86d909731e0295c6c23ab887fa1937f71c07f8e18f84a4f0823bcb88ecfdc2b/ITISPL-ATS-BSC-3Y';
                                                    }else if(basic=="5"){
                                                        document.getElementById("basic_btn").innerHTML = 'Buy Now at ₹14,999.00/-';
                                                        document.getElementById("basic_btn").href = 'https://subscriptions.infotroop.co.in/subscribe/a86d909731e0295c6c23ab887fa1937f71c07f8e18f84a4f0823bcb88ecfdc2b/ITISPL-ATS-BSC-5Y';
                                                    }
                                                }
                                            </script>
                                            <th class="text-center ">
                                                <div class="min-w- mb-15 " style="width: 220px !important;">
                                                    <div class="text-primary fs-3 fw-bold ">Standard</div>
                                                    <br/>
                                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select..." name="standard" id="standard" onChange="fnStandardBtn();">
                                                        <option value=""></option>
                                                        <option value="1">1 Year</option>
                                                        <option value="3">3 Years</option>
                                                        <option value="5">5 Years</option>
                                                    ...
                                                    <br/>
                                                    <br/>
                                                    <a class="btn btn-light-primary fw-bold mx-auto" id="standard_btn">Buy Now</a>
                                                </div>
                                            </th>
                                            <script>
                                                function fnStandardBtn(){
                                                    ...
                                                    if(basic=="1"){
                                                        document.getElementById("standard_btn").innerHTML = 'Buy Now at ₹7,999.00/-';
                                                        document.getElementById("standard_btn").href = 'https://subscriptions.infotroop.co.in/subscribe/a86d909731e0295c6c23ab887fa1937f71c07f8e18f84a4f0823bcb88ecfdc2b/ITISPL-ATS-STD-1Y';
                                                    }else if(basic=="3"){
                                                        document.getElementById("standard_btn").innerHTML = 'Buy Now at ₹16,999.00/-';
                                                        document.getElementById("standard_btn").href = 'https://subscriptions.infotroop.co.in/subscribe/a86d909731e0295c6c23ab887fa1937f71c07f8e18f84a4f0823bcb88ecfdc2b/ITISPL-ATS-STD-3Y';
                                                    }else if(basic=="5"){
                                                        document.getElementById("standard_btn").innerHTML = 'Buy Now at ₹23,999.00/-';
                                                        document.getElementById("standard_btn").href = 'https://subscriptions.infotroop.co.in/subscribe/a86d909731e0295c6c23ab887fa1937f71c07f8e18f84a4f0823bcb88ecfdc2b/ITISPL-ATS-STD-5Y';
                                                    }
                                                }
                                            </script>
                                            <th class="text-center ">
                                                <div class="min-w- mb-15 " style="width: 220px !important;">
                                                    ...
                                                    <br/>
                                                    <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select..." name="premium" id="premium" onChange="fnPremiumBtn();">
                                                        <option value=""></option>
                                                        <option value="1">1 Year</option>
                                                        <option value="3">3 Years</option>
                                                        <option value="5">5 Years</option>
                                                    ...
                                                    <br/>
                                                    <br/>
                                                    <a class="btn btn-light-primary fw-bold mx-auto" id="premium_btn">Buy Now</a>
                                                </div>
                                            </th>
                                            <script>
                                                function fnPremiumBtn(){
                                                    ...
                                                    if(basic=="1"){
                                                        document.getElementById("premium_btn").innerHTML = 'Buy Now at ₹15,999.00/-';
                                                        document.getElementById("premium_btn").href = 'https://subscriptions.infotroop.co.in/subscribe/a86d909731e0295c6c23ab887fa1937f71c07f8e18f84a4f0823bcb88ecfdc2b/ITISPL-ATS-PREM-1Y';
                                                    }else if(basic=="3"){
                                                        document.getElementById("premium_btn").innerHTML = 'Buy Now at ₹31,999.00/-';
                                                        document.getElementById("premium_btn").href = 'https://subscriptions.infotroop.co.in/subscribe/a86d909731e0295c6c23ab887fa1937f71c07f8e18f84a4f0823bcb88ecfdc2b/ITISPL-ATS-PREM-3Y';
                                                    }else if(basic=="5"){
                                                        document.getElementById("premium_btn").innerHTML = 'Buy Now at ₹47,999.00/-';
                                                        document.getElementById("premium_btn").href = 'https://subscriptions.infotroop.co.in/subscribe/a86d909731e0295c6c23ab887fa1937f71c07f8e18f84a4f0823bcb88ecfdc2b/ITISPL-ATS-PREM-5Y';
                                                    }
                                                }
                                            </script>
                                            <th class="text-center ">
                                                <div class="min-w- mb-15 " style="width: 220px !important;">
                                                    ...
                                                    <br/>
                                                    <br/>
                                                    <p><a class="btn btn-light-primary fw-bold mx-auto" href="mailto:sales@infotroop.co.in">sales@infotroop.co.in</a></p>
                                                </div>
                                            </th>
                                    ...
                                    <tr>
                                            <th class="card-rounded-start">
                                                <div class="fw-bold align-items-center ps-9 fs-3" style="font-size: 14px !important;">1 Year Subscription (Max. 5 Assets/ User) </br><span style="font-size: 12px;color: #4c4a4a;">18% GST Extra on Net Total</span></div>
                                            </th>
                                            <td>
                                                <div class="flex-root justify-content-center" style="text-align: center;display: block !important;">
                                                    <p style="font-weight:bold;font-size: 14px;">₹4,999.00/- </br><span style="font-size: 11px;">(User/ Year)</span> </p> 
                                            ...
                                            <td>
                                                <div class="flex-root justify-content-center" style="text-align: center;display: block !important;">
                                                    ...
                                                    <p style="font-weight:bold;font-size: 14px;">₹7,999.00/- </br><span style="font-size: 11px;">(User/ Year)</span> </p> 
                                            ...
                                            <td class="">
                                                <div class="flex-root justify-content-center" style="text-align: center;display: block !important;">
                                                    ...
                                                    <p style="font-weight:bold;font-size: 14px;">₹15,999.00/- </br><span style="font-size: 11px;">(User/ Year)</span> </p> 
                                        ...
                                        <tr>
                                            <th class="card-rounded-start">
                                                <div class="fw-bold align-items-center ps-9 fs-3" style="font-size: 14px !important;">3 Years Subscription (Max. 5 Assets/ User) </br><span style="font-size: 12px;color: #4c4a4a;">18% GST Extra on Net Total</span></div>
                                            </th>
                                            <td>
                                                <div class="flex-root d-flex justify-content-center" style="text-align: center;display: block !important;">
                                                    <!-- <p style="font-weight:bold;">₹9,999.00/- </br>(User/ Year)- 1Y Free</p>  -->
                                                    <p style="font-weight:bold;font-size: 14px;">₹9,999.00/- </br><span style="font-size: 11px;">(User/ Year)- 1Yrs Free</span> </p> 
                                            ...
                                            <td>
                                                <div class="flex-root d-flex justify-content-center" style="text-align: center;display: block !important;">
                                                    ...
                                                    <p style="font-weight:bold;font-size: 14px;">₹16,999.00/- </br><span style="font-size: 11px;">(User/ Year)- 1Yrs Free</span> </p> 
                                            ...
                                            <td class="">
                                                <div class="flex-root d-flex justify-content-center" style="text-align: center;display: block !important;">
                                                    ...
                                                    <p style="font-weight:bold;font-size: 14px;">₹31,999.00/- </br><span style="font-size: 11px;">(User/ Year)- 1Yrs Free</span> </p> 
                                        ...
                                        <tr>
                                            <th class="card-rounded-start">
                                                <div class="fw-bold align-items-center ps-9 fs-3" style="font-size: 14px !important;">5 Years Subscription </br><span style="font-size: 12px;color: #4c4a4a;">(Max. 5 Assets/ User) + GST </span> </div>
                                            </th>
                                            <td>
                                                <div class="flex-root d-flex justify-content-center" style="text-align: center;display: block !important;">
                                                    <!-- <p style="font-weight:bold;">₹14,999.00/- </br>(User/ Year)- 2Yrs Free</p>  -->
                                                    <p style="font-weight:bold;font-size: 14px;">₹14,999.00/- </br><span style="font-size: 11px;">(User/ Year)- 2Yrs Free</span> </p> 
                                            ...
                                            <td>
                                                <div class="flex-root d-flex justify-content-center" style="text-align: center;display: block !important;">
                                                    ...
                                                    <p style="font-weight:bold;font-size: 14px;">₹23,999.00/- </br><span style="font-size: 11px;">(User/ Year)- 2Yrs Free</span> </p>
                                            ...
                                            <td class="">
                                                <div class="flex-root d-flex justify-content-center" style="text-align: center;display: block !important;">
                                                    ...
                                                    <p style="font-weight:bold;font-size: 14px;">₹47,999.00/- </br><span style="font-size: 11px;">(User/ Year)- 2Yrs Free</span> </p>
