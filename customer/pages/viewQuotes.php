                    ...
                    <div class="card p-4 mb-5 mb-xl-10">
                        ...
                        <div class="card-header border-0"  data-bs-toggle="collapse"
                            ...
                            <div class="card-title w-100 justify-content-between">
                                <h3 class="fw-bold">View Warranty Quotes </h3>
                                ...
                                <table id="kt_datatable_vertical_scroll"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>4651</td>
                                            <td>
                                                <button class="btn btn-sm btn-primary" title="View Warranty Quotation"
                                                    data-bs-toggle="modal" data-bs-target="#warrentyQuotation">
...
<!-- View Warranty Modal  -->
<div class="modal fade" tabindex="-1" id="warrentyQuotation">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5>View Warranty Quotation</h5>
            ...
            <div class="modal-body">
                <img src="../assets/media/img/quotation.png"
                    style="width: 100%; max-height: 70vh; overflow-y: scroll; object-fit: contain;" alt="Coming Soon">
            </div>

            <div class="modal-footer">
                <button type="button" class="btn btn-success" title="Accept warranty Quotation"
                    data-bs-toggle="tooltip">Accept</button>
                <button type="button" class="btn btn-danger" title="Reject warranty Quotation"
                    data-bs-toggle="tooltip">Reject</button>
