                            ...
                            <div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 cursor-pointer"  data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
									...
									<div class="card-title m-0">
										<h3 class="fw-bold m-0">Raise Service Request</h3>
									</div>
									<!--end::Card title-->
								</div>
								<!--begin::Card header-->
									...
									<div id="kt_account_profile_details_form" class="form">
										...
										<div class="card-body border-top p-9">
											...
											<div class="row mb-6">
                                                ...
                                                <select name="product_name" id="product_name" aria-label="Select a Language" data-control="select2" data-placeholder="Select Product Type" class="form-select form-select-solid form-select-lg">
                                            ...
                                            <div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="tel" name="model_no" id="model_no" class="form-control form-control-lg form-control-solid" readonly placeholder="Model Number" />
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<input type="text" name="serial_no" id="serial_no" class="form-control form-control-lg form-control-solid" readonly placeholder="Serial Number" />
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<input type="date" name="dop" id="dop" class="form-control form-control-lg form-control-solid" placeholder="Date Of Purchase" />
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
												<!--begin::Label-->
												<label class="col-lg-4 col-form-label fw-semibold fs-6">Under Warranty</label>
												<!--begin::Label-->
												<!--begin::Label-->
												<div class="col-lg-8 d-flex align-items-center">
													<div class="form-check form-check-solid form-switch form-check-custom fv-row">
														<input class="form-check-input w-45px h-30px" type="checkbox" id="under_warranty" checked="checked" />
														<label class="form-check-label" for="under_warranty"></label>
													</div>
												</div>
												<!--begin::Label-->
											</div>
                                            <div class="row mb-6">
												<!--begin::Label-->
												<label class="col-lg-4 col-form-label fw-semibold fs-6">
													<span class="">Warranty Start Date</span>
												</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<input type="date" name="wsd" id="wsd" class="form-control form-control-lg form-control-solid" placeholder="Warranty Start Date" />
												</div>
												<!--end::Col-->
											</div>
                                            <div class="row mb-6">
												<!--begin::Label-->
												<label class="col-lg-4 col-form-label fw-semibold fs-6">
													<span class="">Warranty End Date</span>
												</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<input type="date" name="wed" id="wed" class="form-control form-control-lg form-control-solid" placeholder="Warranty End Date" />
												</div>
												<!--end::Col-->
											</div>
                                            <div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="file" name="warranty_proof" id="warranty_proof" class="form-control form-control-lg form-control-solid" placeholder="Warranty Proof" />
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
