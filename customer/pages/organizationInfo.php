                            ...
                            <div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 cursor-pointer"  data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
									...
									<div class="card-title m-0">
										<h3 class="fw-bold m-0">Organization Details</h3>
									</div>
									<!--end::Card title-->
								</div>
								<!--begin::Card header-->
										...
										<div class="card-body border-top p-9">
											...
											<div class="row mb-6">
												...
												<label class="col-lg-4 col-form-label fw-semibold fs-6">
													...
													<span class="ms-1" data-bs-toggle="tooltip" title="Upload GST Certificate">
														<i class="ki-duotone ki-information-5 text-gray-500 fs-6">
															<span class="path1"></span>
															<span class="path2"></span>
															<span class="path3"></span>
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="file" name="gstCertificate" id="gstCertificate" class="form-control form-control-lg form-control-solid" />
												</div>
												<!--end::Col-->
											</div>
											...
											<div class="row mb-6">
												...
												<label class="col-lg-4 col-form-label fw-semibold fs-6">
													...
													<span class="ms-1" data-bs-toggle="tooltip" title="Upload PAN Card">
														<i class="ki-duotone ki-information-5 text-gray-500 fs-6">
															<span class="path1"></span>
															<span class="path2"></span>
															<span class="path3"></span>
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="file" name="panCard" id="panCard" class="form-control form-control-lg form-control-solid" />
												</div>
												<!--end::Col-->
											</div>
