                                ...
                                <table id="kt_datatable_vertical_scroll"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>IT</td>
                                            <td>IT plays and Crucial role</td>
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td>Sales</td>
                                            <td>Sales and Marketing are parallel</td>
                ...
                <form id="addForm">
                    ...
                    <div data-mdb-input-init class="form-outline mb-8">
                        <div data-mdb-input-init class="form-outline">
                            ...
                            <input type="text" id="name" class="form-control" placeholder="Describe the department" required />
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form id="editForm">
                   ...
                   <div data-mdb-input-init class="form-outline mb-4">
                    ...
                    <div class="form-check d-flex">
                        <input class="form-check-input me-2" type="checkbox" id="status" value=""/>
                        <label class="required form-check-label" for="status"> Status </label>
                    </div>
