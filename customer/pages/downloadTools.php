...
[data-bs-theme="dark"] .my-card:hover {
...
.my-card:hover {
    ...
    box-shadow: 0 0 30px var(--bs-primary-border-subtle);
                            ...
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                ...
                                <div id="kt_account_profile_details_form">
                                    ...
                                    <div class="container py-5">
                                        ...
                                        <form method="post"
                                            action="<?php echo BASE_URL; ?>assets/js/generate_script.php"
                                            id="softwareForm">
                                                ...
                                                <div class="col">
                                                    <div class="card my-card h-100">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text">Programming language and development
                                                                platform</p>
                                                            <div class="row">
                                                                <div class="form-check my-2">
                                                                    <input class="form-check-input app-checkbox"
