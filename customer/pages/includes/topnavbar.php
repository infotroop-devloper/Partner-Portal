<!--begin::Header-->
<div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-animation="false" data-kt-sticky-offset="{default: '200px', lg: '300px'}" style="background: radial-gradient(circle, #fff, rgb(150 185 243));">
	<!--begin::Container-->
		...
		<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
			...
			<div class="flex-grow-1">
				...
				<a href="<?php echo BASE_URL;?>pages/dashboard.php">
					<img alt="Logo" src="<?php echo BASE_URL; ?>/assets/media/logos/InfoTroopLogo.png" style="width:50%;" class="h-30px" />
				</a>
				<!--end::Header Logo-->
			</div>
			<!--end::Wrapper-->
