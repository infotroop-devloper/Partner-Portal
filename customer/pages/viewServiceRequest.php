                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div class="card-header border-0"  data-bs-toggle="collapse"
                            ...
                            <div class="card-title w-100 d-flex justify-content-between align-items-center">
                                <h3 class="fw-bold mb-0">Track Raised Requests</h3>

                                <div class="d-flex gap-2 align-items-center">
                                    <!-- Call Support Button -->
                                    <a class="btn btn-success rounded-circle py-3 px-3" title="Call Support"
                                        data-bs-toggle="tooltip" href="tel:+911234567890">
                                    ...
                                    <select class="form-select" id="filterStatus">
                                        ...
                                        <option value="" hidden disabled selected id="clearOption">All</option>
                                ...
                                <table id="kt_datatable_vertical_scroll"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-primary" title="Raising Request."
                                                    ...
                                                    <i class="fas fa-ticket"></i>Edit ticket
                                                </button>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>ahfb123</td>
                                            <td>47892659</td>
                                            <td><span class="badge text-white bg-primary">Assigned</span></td>
                                            <td>
                                                <button class="btn btn-sm btn-primary" title="Raising Request."
                                                    data-bs-toggle="modal" data-bs-target="#assignUser">
                                                    <i class="fas fa-ticket"></i>Edit ticket
                                        ...
                                        <tr>
                                            ...
                                            <td>vnasdn245</td>
                                            <td>47892659</td>
                                            <td><span class="badge text-white bg-warning">Open</span> <span
                                                    class="badge text-white bg-danger">Escalated</span></td>
                                            <td>
                                                <button class="btn btn-sm btn-primary" title="Raising Request."
                                                    data-bs-toggle="modal" data-bs-target="#assignUser">
                                                    <i class="fas fa-ticket"></i>Edit ticket
                    ...
                    <div class="card-body p-9">
                        ...
                        <form id="raiseServiceRequest">
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="file" class="form-control" name="upload_proof_file"
...
$(document).ready(function() {
    $('#assigned_user').select2({
        ...
        width: '100%' // Ensure it stretches to fit
    });
});
