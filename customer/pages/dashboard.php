...
<div class="d-flex flex-column flex-root">
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <section class="banner-img my-2" style="background-image: url('../assets/media/img/banner-image4.jpg'); 
                            ...
                            <div class="mb-5 mb-lg-10">
                                ...
                                <ul class="nav row mb-lg-10">
                                    <li class="nav-item col-12 col-lg mb-5 mb-lg-0">
                                        <a class="nav-link btn btn-flex btn-color-muted btn-outline btn-outline-default btn-active-danger d-flex flex-grow-1 flex-column flex-center py-5 h-1250px h-lg-150px"
                                    ...
                                    <li class="nav-item col-12 col-lg mb-5 mb-lg-0">
                                        <a class="nav-link btn btn-flex btn-color-muted btn-outline btn-outline-default btn-active-danger d-flex flex-grow-1 flex-column flex-center py-5 h-1250px h-lg-150px active"
                                            ...
                                            <div class="card-header border-0 pt-5">
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                        data-kt-menu="true" id="kt_menu_66066179615dd">
                                                        <!--begin::Header-->
                                                        <div class="px-7 py-5">
                                                            ...
                                                            <div class="mb-10">
                                                                ...
                                                                <div>
                                                                    <select class="form-select form-select-solid"
                                                                        ...
                                                                        data-dropdown-parent="#kt_menu_66066179615dd"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div class="symbol symbol-50px me-2">
                                                                        <span class="symbol-label">
                                                                            <img src="<?php echo BASE_URL; ?>/assets/media/svg/brand-logos/plurk.svg"
                                                                ...
                                                                <td>
                                                                    <a href="#"
                                                                        ...
                                                                        Authors</a>
                                                                    <span
                                                                        class="text-muted fw-semibold d-block fs-7">Successful
                                                                        Fellas</span>
                                                                </td>
                                                                <td class="text-end">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="symbol symbol-50px me-2">
                                                                        <span class="symbol-label">
                                                                            <img src="<?php echo BASE_URL; ?>/assets/media/svg/brand-logos/telegram.svg"
                                                                                class="h-50 align-self-center" alt="" />
                                                                        </span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        ...
                                                                        Authors</a>
                                                                    <span
                                                                        class="text-muted fw-semibold d-block fs-7">Most
                                                                        Successful</span>
                                                                </td>
                                                                <td class="text-end">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="symbol symbol-50px me-2">
                                                                        <span class="symbol-label">
                                                                            <img src="<?php echo BASE_URL; ?>/assets/media/svg/brand-logos/vimeo.svg"
                                                                                class="h-50 align-self-center" alt="" />
                                                                        </span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        ...
                                                                        Users</a>
                                                                    <span
                                                                        class="text-muted fw-semibold d-block fs-7">Awesome
                                                                        Users</span>
                                                                </td>
                                                                <td class="text-end">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="symbol symbol-50px me-2">
                                                                        <span class="symbol-label">
                                                                            <img src="<?php echo BASE_URL; ?>/assets/media/svg/brand-logos/bebo.svg"
                                                                                class="h-50 align-self-center" alt="" />
                                                                        </span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        ...
                                                                        Customers</a>
                                                                    <span
                                                                        class="text-muted fw-semibold d-block fs-7">Best
                                                                        Customers</span>
                                                                </td>
                                                                <td class="text-end">
                                                                    <span
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="symbol symbol-50px me-2">
                                                                        <span class="symbol-label">
                                                                            <img src="<?php echo BASE_URL; ?>/assets/media/svg/brand-logos/kickstarter.svg"
                                                                                class="h-50 align-self-center" alt="" />
                                                                        </span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <a href="#"
                                                                        ...
                                                                        Theme</a>
                                                                    <span
                                                                        class="text-muted fw-semibold d-block fs-7">Amazing
                                                                        Templates</span>
                                                                </td>
                                                                <td class="text-end">
                                                                    <span
                                                    ...
                                                    <table class="table align-middle gs-0 gy-3">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div class="symbol symbol-50px me-2">
                                                                        <span class="symbol-label bg-light-success">
                                                                            <i
                                                                                class="ki-duotone ki-basket fs-2x text-success">
                                                                                <span class="path1"></span>
                                                                                <span class="path2"></span>
                                                                                <span class="path3"></span>
                                                                                <span class="path4"></span>
                                                                ...
                                                                <td class="text-end text-muted fw-bold">ReactJs, HTML
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="symbol symbol-50px me-2">
                                                                        <span class="symbol-label bg-light-danger">
                                                                            <i
                                                                                class="ki-duotone ki-element-11 fs-2x text-danger">
                                                                                <span class="path1"></span>
                                                                                <span class="path2"></span>
                                                                                <span class="path3"></span>
                                                                                <span class="path4"></span>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="symbol symbol-50px me-2">
                                                                        <span class="symbol-label bg-light-info">
                                                                            <i
                                                                                class="ki-duotone ki-briefcase fs-2x text-info">
                                                                                <span class="path1"></span>
                                                                                <span class="path2"></span>
                                                                            </i>
                                                                        </span>
                                                                ...
                                                                <td class="text-end text-muted fw-bold">Laravel,
                                                                    Metronic</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-end">
                                                                            <a href="#"
                                                                                class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary">
                                                                                <i
                                                                                    class="ki-duotone ki-arrow-right fs-2">
                                                                                    <span class="path1"></span>
                                                                                    <span class="path2"></span>
                                                                                </i>
                                                                            </a>
                                                            ...
                                                            <table class="table align-middle gs-0 gy-3">
                                                                ...
                                                                <tbody>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="rating">
                                                                                <div class="rating-label checked">
                                                                                    <i
                                                                                        class="ki-duotone ki-star fs-6"></i>
                                                                                </div>
                                                                                <div class="rating-label checked">
                                                                                    <i
                                                                                        class="ki-duotone ki-star fs-6"></i>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-50px">
                                                                                <img src="<?php echo BASE_URL; ?>/assets/media/avatars/300-5.jpg"
                                                                                    alt="" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-50px">
                                                                                <img src="<?php echo BASE_URL; ?>/assets/media/avatars/300-20.jpg"
                                                                                    alt="" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-50px">
                                                                                <img src="<?php echo BASE_URL; ?>/assets/media/avatars/300-23.jpg"
                                                                                    alt="" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-50px">
                                                                                <img src="<?php echo BASE_URL; ?>/assets/media/avatars/300-10.jpg"
                                                                                    alt="" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                            ...
                                                            <table class="table align-middle gs-0 gy-3">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-50px">
                                                                                <img src="<?php echo BASE_URL; ?>/assets/media/svg/avatars/043-boy-18.svg"
                                                                                    alt="" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-50px">
                                                                                <img src="<?php echo BASE_URL; ?>/assets/media/svg/avatars/014-girl-7.svg"
                                                                                    alt="" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-50px">
                                                                                <img src="<?php echo BASE_URL; ?>/assets/media/svg/avatars/018-girl-9.svg"
                                                                                    alt="" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-50px">
                                                                                <img src="<?php echo BASE_URL; ?>/assets/media/svg/avatars/001-boy.svg"
                                                                                    alt="" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                            ...
                                                            <table class="table align-middle gs-0 gy-3">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-50px">
                                                                                <img src="<?php echo BASE_URL; ?>/assets/media/svg/avatars/047-girl-25.svg"
                                                                                    alt="" />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header border-0 pt-5">
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <!--begin::Menu 1-->
                                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                        data-kt-menu="true" id="kt_menu_6606617961c6b">
                                                        <!--begin::Header-->
                                                        <div class="px-7 py-5">
                                                            <div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
                                                        </div>
                                                            ...
                                                            <div class="mb-10">
                                                                ...
                                                                <div>
                                                                    <select class="form-select form-select-solid"
                                                                        ...
                                                                        data-close-on-select="false"
                                                                        data-placeholder="Select option"
                                                                        data-dropdown-parent="#kt_menu_6606617961c6b"
                                                                        data-allow-clear="true">
                                                                        <option></option>
                                                                        <option value="1">Approved</option>
                                                                        <option value="2">Pending</option>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span
                                                                    class="text-gray-900 fw-bold d-block fs-5">$200,500</span>
                                                            </td>
                                                            <td class="text-end">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="text-muted fw-semibold d-block fs-7">Paid</span>
                                                                <span
                                                                    class="text-gray-900 fw-bold d-block fs-5">$1,200,000</span>
                                                            </td>
                                                            <td class="text-end">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="text-muted fw-semibold d-block fs-7">Paid</span>
                                                                <span
                                                                    class="text-gray-900 fw-bold d-block fs-5">$3,400,000</span>
                                                            </td>
                                                            <td class="text-end">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#"
                                                                    class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Kevin
                                                                    Leonard</a>
                                                                <span class="text-muted fw-semibold d-block">Art
                                                                    Director</span>
                                                            </td>
                                                            <td>
                                                                <span
                            ...
                            <div class="card mb-5 mb-lg-10">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="mixed-widget-12-chart card-rounded-bottom bg-success"
                                        data-kt-color="success" style="height: 250px"></div>
                                    <!--end::Chart-->
                                    <!--begin::Stats-->
                            ...
                            <div class="card mb-5 mb-lg-10">
                                ...
                                <div class="card-body pt-5">
                                    ...
                                    <div class="d-flex align-items-sm-center">
                                        ...
                                        <div class="symbol symbol-50px me-5">
                                            <span class="symbol-label">
                                                <img src="<?php echo BASE_URL; ?>/assets/media/svg/brand-logos/fox-hub.svg"
                                                    class="h-50 align-self-center" alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                            ...
                            <div class="card mb-10">
                                ...
                                <div class="card-header align-items-center border-0 mt-4">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <!--begin::Menu 1-->
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                            data-kt-menu="true" id="kt_menu_66066179620b0">
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                                <div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
                                            </div>
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <div>
                                                        <select class="form-select form-select-solid"
                                                            ...
                                                            data-close-on-select="false"
                                                            data-placeholder="Select option"
                                                            data-dropdown-parent="#kt_menu_66066179620b0"
                                                            data-allow-clear="true">
                                                            <option></option>
                                                            <option value="1">Approved</option>
                                                            <option value="2">Pending</option>
