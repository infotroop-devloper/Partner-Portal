...
var KTAuthNewPassword = function() {
    ...
    return {
        init: function() {
            t = document.querySelector("#kt_new_password_form"), e = document.querySelector("#kt_new_password_submit"), n = KTPasswordMeter.getInstance(t.querySelector('[data-kt-password-meter="true"]')), r = FormValidation.formValidation(t, {
                    fields: {
                        password: {
                            validators: {
                                notEmpty: {
                                ...
                                callback: {
                                    ...
                                    callback: function(t) {
                                        if (t.value.length > 0) return n.getScore() > 50
                                    }
                                }
                            }
                        },
                ...
                function(t) {
                    ...
                    n.preventDefault(), r.revalidateField("password"), r.validate().then(function(r) {
                        "Valid" == r ? (e.setAttribute("data-kt-indicator", "on"), e.disabled = !0, axios.post(e.closest("form").getAttribute("action"), new FormData(t)).then(function(e) {
                            if (e) {
                                t.reset();
                                let r = t.getAttribute("data-kt-redirect-url");
                                r && (location.href = r)
                            } else Swal.fire({
                    ...
                    o.preventDefault(), r.revalidateField("password"), r.validate().then(function(r) {
                        "Valid" == r ? (e.setAttribute("data-kt-indicator", "on"), e.disabled = !0, setTimeout(function() {
                            e.removeAttribute("data-kt-indicator"), e.disabled = !1/*, Swal.fire({
                                ...
                                if (e.isConfirmed) {
                                    t.querySelector('[name="password"]').value = "", t.querySelector('[name="confirm-password"]').value = "", n.reset();
