        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-fluid">
                ...
                <div class="content flex-row-fluid" id="kt_content">
                    <span class="card-label fw-bold text-gray-900 fs-2" style="margin-left:10px;">Pending
                        Approvals</span>
                    <div class="row my-4">
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">
                                                Orders Waiting Approval</div>
                                            <span id="newRequestCount" class="fs-2hx fw-bold text-gray-800 me-2 lh-1">2</span>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold fs-3 mb-1">Pending Approval</span>
                                </h3>
                                    ...
                                    <table id="kt_datatable_vertical_scroll"
                                        ...
                                        <tbody class="text-center">
                                            <tr>
                                                ...
                                                <td>Stock Check</td>
                                                <td>
                                                    <button class="btn-success btn btn-sm" title="Accept Order"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-check"></i>
                                                    </button>
                                                    <button class="btn-danger btn btn-sm" title="Reject Order"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                    <button class="btn-info btn btn-sm" title="Request More Info"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-question"></i>
                                                    </button>
                                                    <button class="btn-primary btn btn-sm" title="Assign Inventory "
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-box"></i>
                                                    </button>
                                                    <button class="btn-warning btn btn-sm" title="Forward to Manager"
                                                        data-bs-toggle="tooltip">
