...
<div id="kt_header" class="header shadow-lg" style="background:#fff;" data-kt-sticky="true" data-kt-sticky-name="header"
    ...
    <div class="container-fluid d-flex align-items-center flex-lg-stack">
        <div class="d-flex align-items-center justify-content-between w-100 me-2 me-lg-5">
            <!-- Logo: fixed width -->
            ...
            <!-- Text block: fill remaining space -->
            <div style="padding-left:10px;">
                <h2 style="font-weight:bold; margin-bottom:0px; margin-top:18px;">
                    Partner Registration Form
                </h2>
                <h5 style="font-weight:unset;">
                    Application for Partner Program Enrollment
                </h5>
            </div>
        </div>
    </div>
...
<div class="d-flex flex-column flex-root" style="margin-top: 80px;">
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper" style="padding: 0px;">
            ...
            <section class="banner-img my-2" style="background-image: url('../assets/media/img/banner-image5.jpg'); 
							background-size: cover; background-position: top; height: 250px; background-repeat:no-repeat">
            </section>
            ...
            <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-fluid">
                ...
                <div class="content flex-row-fluid" id="kt_content">
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid gap-10"
                        ...
                        <!--begin::Aside-->
                        <div class="card d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px w-xxl-500px"
                            style="--bs-card-box-shadow: 0px 3px 4px 0px rgb(0 0 0 / 34%);">
                            <!--begin::Wrapper-->
                                    ...
                                    <div class="stepper-item current" data-kt-stepper-element="nav">
                                        ...
                                        <div class="stepper-wrapper">
                                            ...
                                            <div class="stepper-label">
                                                ...
                                                <div class="stepper-desc fw-semibold">Confirmation of business profile
                                                </div>
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                    ...
                                    <div class="stepper-item" data-kt-stepper-element="nav">
                                        ...
                                        <div class="stepper-wrapper">
                                            ...
                                            <div class="stepper-label">
                                                ...
                                                <div class="stepper-desc fw-semibold">Provide your company information
                                                </div>
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                    ...
                                    <div class="stepper-item" data-kt-stepper-element="nav">
                                        ...
                                        <div class="stepper-wrapper">
                                            ...
                                            <div class="stepper-label">
                                                ...
                                                <div class="stepper-desc fw-semibold">Please provide your company's
                                                    profile below.</div>
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                    ...
                                    <div class="stepper-item" data-kt-stepper-element="nav">
                                        ...
                                        <div class="stepper-wrapper">
                                            ...
                                            <div class="stepper-label">
                                                ...
                                                <div class="stepper-desc fw-semibold">Please agree to the terms and
                        ...
                        <div class="card d-flex flex-row-fluid flex-center"
                            style="--bs-card-box-shadow: 0px 3px 4px 0px rgb(0 0 0 / 34%);">
                            <!--begin::Form-->
                            <div class="card-body py-20 w-100 mw-xl-1000px  row" novalidate="novalidate"
                                id="kt_create_account_form">
                                <!--begin::Step 1-->

                                <div class="current w-100" data-kt-stepper-element="content">
                                    <!--begin::Wrapper-->
                                    <div class="w-100">
                                        ...
                                        <div class="fv-row">
                                            <div class="row">
                                                ...
                                                <div class="fv-row mb-8" id="radioContainer">
                                                    <label
                                                        class="col-lg-8 col-form-label fw-semibold fs-3 required">Select
                                                        Your Primary Business Model</label>
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input me-3" type="radio"
                                                            value="Solution Provider" id="primary_business_model_0"
                                                            name="primary_business_model" />
                                                        <label class="form-check-label" for="primary_business_model_0">
                                                            <div class="fw-bold text-gray-800" style="font-size: 14px;">
                                                                Solution Provider</div>
                                                            <div class="text-gray-600" style="font-size: 12px;">Partners
                                                                specializing in delivering comprehensive IT solutions by
                                                                reselling products and offering customized technical
                                                                services, maintenance, and support tailored to business
                                                                needs.</div>
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-custom form-check-solid"
                                                        ...
                                                        <input class="form-check-input me-3" type="radio"
                                                            value="Value-Added Reseller (VAR)"
                                                            id="primary_business_model_1"
                                                            name="primary_business_model" />
                                                        <label class="form-check-label" for="primary_business_model_1">
                                                            <div class="fw-bold text-gray-800" style="font-size: 14px;">
                                                                Value-Added Reseller (VAR)</div>
                                                            <div class="text-gray-600" style="font-size: 12px;">Partners
                                                                who resell IT hardware and software products, while
                                                                adding value through solution-specific services such as
                                                                installation, integration, and technical expertise to
                                                                address customer-specific requirements.</div>
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-custom form-check-solid"
                                                        style="margin-top: 15px;">
                                                        <input class="form-check-input me-3" type="radio"
                                                            ...
                                                            id="primary_business_model_2"
                                                            name="primary_business_model" />
                                                        <label class="form-check-label" for="primary_business_model_2">
                                                            <div class="fw-bold text-gray-800" style="font-size: 14px;">
                                                                Managed Service Provider (MSP)</div>
                                                            <div class="text-gray-600" style="font-size: 12px;">Partners
                                                                providing ongoing IT infrastructure management,
                                                                including monitoring, support, and optimization, to
                                                                ensure seamless operations for businesses and end users.
                                                            </div>
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-custom form-check-solid"
                                                        style="margin-top: 15px;">
                                                        <input class="form-check-input me-3" type="radio"
                                                            value="Cloud Service Partner" id="primary_business_model_3"
                                                            name="primary_business_model" />
                                                        <label class="form-check-label" for="primary_business_model_3">
                                                            <div class="fw-bold text-gray-800" style="font-size: 14px;">
                                                                Cloud Service Partner</div>
                                                            <div class="text-gray-600" style="font-size: 12px;">
                                                                Businesses that host or manage cloud-based IT solutions,
                                                                including Software as a Service (SaaS), Infrastructure
                                                                as a Service (IaaS), and end-user IT infrastructure
                                                                management.</div>
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-custom form-check-solid"
                                                        style="margin-top: 15px;">
                                                        <input class="form-check-input me-3" type="radio"
                                                            value="Service Provider- For Government Orgnizations & PSUs"
                                                            id="primary_business_model_4"
                                                            name="primary_business_model" />
                                                        <label class="form-check-label" for="primary_business_model_4">
                                                            <div class="fw-bold text-gray-800" style="font-size: 14px;">
                                                                Service Provider- For Government Orgnizations & PSUs
                                                            </div>
                                                            <div class="text-gray-600" style="font-size: 12px;">Partners
                                                                focusing on delivering IT products, services, and
                                                                solutions to government agencies, meeting regulatory and
                                                                compliance standards (India Only)</div>
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-custom form-check-solid"
                                                        style="margin-top: 15px;">
                                                        <input class="form-check-input me-3" type="radio"
                                                            value="Consumer Partner" id="primary_business_model_5"
                                                            name="primary_business_model" />
                                                        <label class="form-check-label" for="primary_business_model_5">
                                                            <div class="fw-bold text-gray-800" style="font-size: 14px;">
                                                                Consumer Partner</div>
                                                            <div class="text-gray-600" style="font-size: 12px;">
                                                                Retailers and resellers specializing in consumer-focused
                                                                IT products, offering affordable and reliable options
                                                                for individual and small business customers in targeted
                                                                regions.</div>
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-custom form-check-solid"
                                                        style="margin-top: 15px;">
                                                        <input class="form-check-input me-3" type="radio"
                                                            value="Corporate Partner" id="primary_business_model_6"
                                                            name="primary_business_model" />
                                                        <label class="form-check-label" for="primary_business_model_6">
                                                            <div class="fw-bold text-gray-800" style="font-size: 14px;">
                                                                Corporate Partner</div>
                                                            <div class="text-gray-600" style="font-size: 12px;">
                                                                Enterprises and partners that specialize in providing IT
                                                                solutions, including hardware, software, and managed
                                                                services, to large corporations and multi-site
                                                                organizations.</div>
                                                        </label>
                                                    </div>
                                                </div>
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="fv-row mb-8">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6 required">Business
                                                Type</label>
                                            <div class="col-lg-12 fv-row">
                                                <select name="business_type" id="business_type"
                                                    data-placeholder="Select Business Type"
                                                    onchange="fn_companytype(this)"
                                                    class="form-select form-select-solid" data-control="select2"
                                                    data-hide-search="true">
                                                    <option></option>
                                                    <option value="Independent Business Consultant">Independent Business
                                                        Consultant</option>
                                                    ...
                                                    <option value="Private Limited Company (PVT. LTD.)">Private Limited
                                                        Company (PVT. LTD.)</option>
                                                    <!-- <option value="Public Limited Company (LTD.)">Public Limited Company
                                                        (LTD.)</option> -->
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6 required">Company
                                                Name</label>
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="partner_name" id="partner_name" placeholder="" value="" />
                                        </div>

                                        <div class="mb-10 fv-row">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Company Locally Know
                                                As</label>
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="local_company_name" id="local_company_name" placeholder=""
                                                value="" />
                                        </div>

                                        <div class="mb-10 fv-row">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6 required">Head of the
                                                Company</label>
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="company_head" id="company_head" placeholder="" value="" />
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6 required">Company
                                                Website / URL</label>
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="website_url" id="website_url" placeholder="" value="" />
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <div class="row">
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    <label
                                                        class="col-lg-4 col-form-label fw-semibold fs-6 required">E-Mail
                                                        ID</label>
                                                    <input type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="email_id" id="email_id" placeholder="" value="" />
                                                </div>
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    <label class="form-label  required">Telephone/
                                                        Mobile No.</label>
                                                    <input type="tel"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="phone_no" id="phone_no" placeholder="" value="" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            <div class="row">
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    <label class="col-lg-4 col-form-label fw-semibold fs-6 required">PAN
                                                        No.</label>
                                                    <input type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="pan" id="pan" placeholder="" value="" />
                                                </div>
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    <label
                                                        class="col-lg-4 col-form-label fw-semibold fs-6">GSTIN</label>
                                                    <input type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="gst" id="gst" placeholder="" value="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <textarea class="form-control form-control-lg form-control-solid"
                                                name="company_address" id="company_address" rows="5"></textarea>
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            <div class="row">
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    <label
                                                        class="col-lg-4 col-form-label fw-semibold fs-6 required">City</label>
                                                    <input type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="city" id="city" placeholder="" value="" />
                                                </div>
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    <label
                                                        class="col-lg-4 col-form-label fw-semibold fs-6 required">State</label>
                                                    <input type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="state" id="state" placeholder="" value="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            <div class="row">
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    <label
                                                        class="col-lg-4 col-form-label fw-semibold fs-6 required">Country</label>
                                                    <input type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="pcountry" id="pcountry" placeholder="" value="" />
                                                </div>
                                                <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                    <label
                                                        class="col-lg-4 col-form-label fw-semibold fs-6 required">Zipcode</label>
                                                    <input type="text"
                                                        class="form-control form-control-lg form-control-solid"
                                                        name="zipcode" id="zipcode" placeholder="" value="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="Independent_Business_Consultant" style="display:none;">
                                            <h5>Independent Business Consultant</h5>
                                            <!-- GOVT ID -->
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Government-issued ID
                                                    proof</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="govt_id_proof"
                                                        id="govt_id_proof">
                                                </label>
                                            </div>

                                            <!-- ADDRESS DOCUMENT -->
                                            <div class="mb-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Address proof</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="address_document"
                                                        id="address_document">
                                                </label>
                                            </div>
                                            ...
                                            <div class="mb-10 fv-row file-upload-wrapper">
                                                ...
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="bank_document" id="">
                                                </label>
                                            </div>

                                            <!-- GST CERTIFICATE -->
                                            <div class="mb-10 fv-row file-upload-wrapper">
                                                <label class="form-label">GST Registration Certificate</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="gst_certificate"
                                                        id="gst_certificate">
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div id="Proprietorship_Firm" style="display:none;">
                                            ...
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Proprietor's
                                                    address proof (Aadhar Card, Utility Bill, Bank Statement, or Rent
                                                    Agreement)</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                            ...
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Business
                                                    registration proof (Shop Act License or Udyam Certificate)</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="business_document"
                                            ...
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Bank account
                                                    details (Cancelled Cheque or Bank Statement)</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="bank_document"
                                                        id="bank_document">
                                                </label>
                                            </div>
                                        </div>
                                        <div id="Partnership_Firm" style="display:none;">
                                            ...
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Partnership
                                                    Deed (Registered)</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="partnership_deed"
                                                        id="partnership_deed">
                                                </label>
                                            </div>
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">PAN Card of
                                                    the Partnership Firm</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="pan_document"
                                                        id="pan_document">
                                                </label>
                                            </div>
                                            <div class="my-10 fv-row file-upload-wrapper">
                                            ...
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Partne's ID
                                                    proof (Aadhar Card, Passport, or PAN Card)</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="partner_proof"
                                                        id="partner_proof">
                                                </label>
                                            </div>
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Partner's
                                                    address proof (Utility Bill, Bank Statement, or Rent
                                                    Agreement)</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="address_proof"
                                                        id="address_proof">
                                                </label>
                                            </div>
                                            <div class="my-10 fv-row file-upload-wrapper">
                                        ...
                                        <div id="One_Person_Company" style="display:none;">
                                            ...
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Incorporation
                                                    Certificate of OPC</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="coi_opc" id="coi_opc">
                                                </label>
                                            </div>
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Director's ID
                                                    proof (Aadhar Card, Passport, or PAN Card)</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="director_proof"
                                                        id="director_proof">
                                                </label>
                                            </div>
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Director
                                                    Identification Number (DIN)</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="din" id="din">
                                                </label>
                                            </div>
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">PAN Card of
                                                ...
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="pan_no" id="pan_no">
                                                </label>
                                            </div>
                                            <div class="mb-10 fv-row file-upload-wrapper">
                                                <label class="form-label">GST Registration Certificate</label>
                                            ...
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Memorandum of
                                                    Association (MoA) and Articles of Association (AoA)</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="moa_aoa" id="moa_aoa">
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div id="Limited_Liability_Partnership" style="display:none;">
                                            ...
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">Incorporation
                                                    Certificate of LLP</label>
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="coi_llp" id="coi_llp">
                                                </label>
                                            </div>
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                <label class="form-label">PAN Card of
                                                ...
                                                <label class="upload-label">
                                                    <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                        style="color: #1b84ff;"></i>
                                                    <span class="file-name">No file chosen</span>
                                                    <input type="file" class="fileUpload" name="pan_llp" id="pan_llp">
                                                </label>
                                            </div>
                                                <div class="mb-10 fv-row file-upload-wrapper">
                                                    <label class="form-label">GST Registration Certificate</label>
                                                ...
                                                <div class="mb-10 fv-row file-upload-wrapper">
                                                    <label class="form-label">LLP
                                                        Agreement</label>
                                                    <label class="upload-label">
                                                        <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                            style="color: #1b84ff;"></i>
                                                        <span class="file-name">No file chosen</span>
                                                        <input type="file" class="fileUpload" name="llp_agreement"
                                                            id="llp_agreement">
                                                    </label>
                                                </div>
                                                <div class="mb-10 fv-row file-upload-wrapper">
                                                    <label class="form-label">Partner's ID
                                                        proof (Aadhar Card, Passport, or PAN Card)</label>
                                                    <label class="upload-label">
                                                        <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                            style="color: #1b84ff;"></i>
                                                ...
                                                <div class="mb-10 fv-row file-upload-wrapper">
                                                    ...
                                                    <label class="upload-label">
                                                        <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                            style="color: #1b84ff;"></i>
                                                        <span class="file-name">No file chosen</span>
                                                        <input type="file" class="fileUpload" name="pan_company"
                                                            id="pan_company">
                                                    </label>
                                                </div>
                                                <div class="mb-10 fv-row file-upload-wrapper">
                                            ...
                                            <div class="my-10 fv-row file-upload-wrapper">
                                                ...
                                                <div class="my-10 fv-row file-upload-wrapper">
                                                    <label class="form-label">Board
                                                        Resolution authorizing partnership</label>
                                                    <label class="upload-label">
                                                        <i class="fas fa-cloud-arrow-up fs-2x px-5 py-3 upload-icon"
                                                            style="color: #1b84ff;"></i>
                                                        <span class="file-name">No file chosen</span>
                                                        <input type="file" class="fileUpload" name="board_resolution"
                                                            id="board_resolution">
                                                    </label>
                                                </div>
                                                <div class="my-10 fv-row file-upload-wrapper">
                                    ...
                                    <div data-kt-stepper-element="content">
                                        ...
                                        <div class="w-100">
                                            <div class="mb-10 fv-row">
                                                <label class="form-label  required">What is
                                                    your organization's total revenue?</label>
                                                <input type="text"
                                                    class="form-control form-control-lg form-control-solid"
                                                    name="total_revenue" id="total_revenue" placeholder="" value="" />
                                            </div>
                                            <div class="mb-10 fv-row">
                                                <label class="form-label  required">How many
                                                    active customers does your company have?</label>
                                                <input type="text"
                                                    class="form-control form-control-lg form-control-solid"
                                                    name="active_customer" id="active_customer" placeholder=""
                                                    value="" />
                                            </div>
                                            <div class="mb-10 fv-row">
                                                <label class="form-label  required">How many
                                                    employees does your company have?</label>
                                                <input type="text"
                                                    class="form-control form-control-lg form-control-solid"
                                                    name="head_count" id="head_count" placeholder="" value="" />
                                            </div>
                                            <div class="mb-10 fv-row">
                                                <label class="form-label  required">How many
                                                    employees in your organization are part of the sales staff?</label>
                                                <input type="text"
                                                    class="form-control form-control-lg form-control-solid"
                                                    name="sales_count" id="sales_count" placeholder="" value="" />
                                            </div>
                                            <div class="mb-10 fv-row">
                                                <label class="form-label  required">How many
                                                    employees in your organization are part of the technical
                                                    staff?</label>
                                                <input type="text"
                                                    class="form-control form-control-lg form-control-solid"
                                                    name="tech_count" id="tech_count" placeholder="" value="" />
                                            </div>
                                        </div>
                                        <!--end::Wrapper-->
                                    </div>
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="mb-10 fv-row">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                        <label
                                                            class="col-lg-6 col-form-label fw-semibold fs-6 required">Job
                                                            Title</label>
                                                        <input type="text"
                                                            class="form-control form-control-lg form-control-solid"
                                                            name="job_title" id="job_title" placeholder="" value="" />
                                                    </div>
                                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                        <label class="form-label  required">Job
                                                            Roll in your Orgnization</label>
                                                        <input type="text"
                                                            class="form-control form-control-lg form-control-solid"
                                                            name="job_role" id="job_role" placeholder="" value="" />
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="mb-10 fv-row">
                                                <label class="form-label  required">E-Mail
                                                    ID</label>
                                                <input type="text"
                                                    class="form-control form-control-lg form-control-solid"
                                                    name="contact_email_id" id="contact_email_id" placeholder=""
                                                    value="" />
                                            </div>
                                            ...
                                            <div class="mb-10 fv-row">
                                                <div class="row">
                                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                        <label
                                                            class="col-lg-6 col-form-label fw-semibold fs-6 required">Phone
                                                            No</label>
                                                        <input type="text"
                                                            class="form-control form-control-lg form-control-solid"
                                                            name="contact_phone_no" id="contact_phone_no" placeholder=""
                                                            value="" />
                                                    </div>
                                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                                        <label
                                                            class="col-lg-6 col-form-label fw-semibold fs-6 required">Mobile
                                                            No</label>
                                                        <input type="text"
                                                            class="form-control form-control-lg form-control-solid"
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <textarea class="form-control form-control-lg form-control-solid"
                                                    name="contact_address" id="contact_address" rows="5"></textarea>
                                            </div>

                                            <div class="fv-row mb-10">
                                                <input type="checkbox" placeholder="" name="agree_tnc" id="agree_tnc"
                                                    value="" /> <span style="font-weight:bold;">Yes, I would like
                                                    InfoTroop
                                                    to send me email communications.</span><br />
                                                Opting in for Partner communications will enable you to receive
                                                important
                                                updates about the InfoTroop Partner Program benefits and rewards,
                                                product &
                                                Service launches, selling tools, training, and marketing tools.
                                                For more details on the information practices of <a href="#">InfoTroop
                                                    and
                                                    its Partner companies</a>, see our <a href="">Privacy Statement</a>.
                                                You
                                    ...
                                    <div data-kt-stepper-element="content">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="fv-row mb-10 before_api_call">
                                                <input type="checkbox" placeholder="" name="last_agree_tnc"
                                                    id="last_agree_tnc" value="" /> I accept the InfoTroop Partner
                                                Program
                                                Terms and Conditions
                                            </div>
                                            <p class="before_api_call">
                                                By submitting this form, you acknowledge that InfoTroop will process
                                                personal data in accordance with the Privacy Policy and, if you
                                                indicated
                                                that you accept the InfoTroop Partner Terms and Conditions,
                                                you warrant that you have full corporate power and authority to do so.
                                            </p>
                                            <p class="before_api_call">
                                                By accepting the InfoTroop Partner Terms and Conditions, you represent
                                                and
                                                warrant that you will not export, re-export, transfer, or otherwise make
                                                available InfoTroop Products & Services, directly or indirectly, to any
                                                country, region, individual or entity in violation of, or for purposes
                                                prohibited by, the Sanctions and Export Control Laws. Currently,
                                                InfoTroop
                                                prohibit all Sales/ Purchase of Services & Prodcts to/from the following
                                            ...
                                            <div class="pb-8 pb-lg-10 after_api_call" style="display:none;">
                                                ...
                                                <div class="text-muted fw-semibold fs-6">THANK YOU FOR CHOOSING
                                                    <b>INFOTROOP</b>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="d-flex flex-stack flex-grow-1">
                                                        <div class="fw-semibold">
                                                            <div class="fs-6 text-gray-700">
                                                                We have received your application to participate in the
                                                                InfoTroop IT Solutions Partner Program.<br>
                                                                Your Application Number is <b><span
                                                                        class="partner_onboard_number">PR004669858</span></b>.<br>
                                                                We strive to process your request within 3-5 business
                                                                days.
                                                                You may be contacted to provide additional documentation
                                                                or
                                                                clarification as we review your application.
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="d-flex flex-stack pt-10">
                                        ...
                                        <div class="mr-2">
                                            <button type="button"
                                                class="btn btn-lg btn-light-primary me-3 btn_previous previous_button_btn"
        ...
        return {
            init: function() {
                (e = document.querySelector("#kt_modal_create_account")) && new bootstrap.Modal(e), (t =
                    document
                    .querySelector("#kt_create_account_stepper")) && (i = t.querySelector(
                        "#kt_create_account_form"), o = t.querySelector(
                    '[data-kt-stepper-action="submit"]'),
                    a = t.querySelector('[data-kt-stepper-action="next"]'), (r = new KTStepper(t)).on(
                        "kt.stepper.changed", (function(e) {
                            5 === r.getCurrentStepIndex() ? (o.classList.remove("d-none"), o.classList
                                    .add(
                                        "d-inline-block"), a.classList.add("d-none")) : 5 === r
                                .getCurrentStepIndex() ? (o.classList.add("d-none"), a.classList.add(
                                    "d-none")) : (o.classList.remove("d-inline-block"), o.classList
                                    .remove(
                                        "d-none"), a.classList.remove("d-none"))
    ...
    document.querySelectorAll(".fileUpload").forEach(function(input) {
        input.addEventListener("change", function() {
            ...
            icon.style.color = input.files.length > 0 ? "#28a745" : "#1b84ff";
        });
    });
    </script>