        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div class="container-fluid py-5 my-4">
                ...
                <div class="row g-8" id="partnerList">
                    ...
                    <!-- Partner Card 9 -->
                    <div class="col-md-3 partner-card" data-name="Cisco">
                        <div class="card card-hover h-100">
                            <div class="card-body">
                                <img src="../assets/media/img/Cisco_logo.png" class="partner-logo mb-3" alt="Cisco">
                                <h6 class="text-muted">Platinum Partner</h6>
                                <h5>Cisco</h5>
                                <p class="small">Cisco Systems, Inc. is an American multinational digital communications technology conglomerate corporation headquartered in San Jose, California. Cisco develops, manufactures, and sells networking hardware, software, telecommunications equipment and other high-technology services and products. </p>
                                    <br>
                                <p><strong>HQ:</strong> Bangalore, India</p>
                                <hr>
                                <p><strong>Specializations:</strong> 11</p>
                    ...
                    <!-- Partner Card 10 -->
                    <div class="col-md-3 partner-card" data-name="Veritas">
                        <div class="card card-hover h-100">
                            <div class="card-body">
                                <img src="../assets/media/img/Veritas_logo.png" class="partner-logo mb-3" alt="Veritas">
                                <h6 class="text-muted">Platinum Partner</h6>
                                <h5>Veritas</h5>
                                <p class="small">Veritas Technologies LLC is an American international data management company headquartered in Santa Clara, California. The company has its origins in Tolerant Systems, founded in 1983 and later renamed Veritas Software.</p>
                                    <br>
                                <p><strong>HQ:</strong> Mumbai, India</p>
                                <hr>
                                <p><strong>Specializations:</strong> 11</p>
                                <p><strong>Certifications:</strong> 500+</p>
                                <p><strong>Customer Deployments:</strong> 20+</p>
                    ...
                    <!-- Partner Card 11 -->
                    <div class="col-md-3 partner-card" data-name="ViewSonic">
                        <div class="card card-hover h-100">
                            <div class="card-body">
                                <img src="../assets/media/img/ViewSonic_logo.png" class="partner-logo mb-3" alt="ViewSonic">
                                <h6 class="text-muted">Platinum Partner</h6>
                                <h5>ViewSonic</h5>
                                <p class="small">ViewSonic Corporation is an American privately held multinational electronics company with headquarters in Brea, California, United States.</p>
                                    <br>
                                <p><strong>HQ:</strong> New Delhi, India</p>
                                <hr>
                                <p><strong>Specializations:</strong> 11</p>
