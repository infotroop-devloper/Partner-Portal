        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div id="kt_content_container" class="flex flex-column-fluid align-items-start container-fluid">
                ...
                <div class="content flex-row-fluid" id="kt_content">
                    <!--begin::Row-->
                    <span class="card-label fw-bold text-gray-900 fs-2" style="margin-left:10px;">Compliance &
                        Certifications</span>
                    <div class="row my-4">
                        ...
                        <div class="col-xl-4 col-md-4 mb-4">
                            <div class="card border-left-primary shadow py-2" style="height: 150px">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col-auto">
                                        <i class="fas fa-stopwatch fs-3x text-gray-300"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border-left-primary shadow py-2" style="height: 150px">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <div class="row no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">
                                                Average Certification Completion Time</div>
                                            <span id="newRequestCount"
                                                class="fs-2hx fw-bold text-gray-800 me-2 lh-1">0</span>
                                        </div>
                                    </div>
                                    ...
                                    <table id="kt_datatable_vertical_scroll"
                                        ...
                                        <thead class="text-center">
                                            <tr class="fw-bold text-muted bg-light">
                                                <th class="ps-4">Certification Type</th>
                                                <th>Description</th>
                                                <th>Status</th>
                                                <th>Actions</th>
                                            </tr>
                                        ...
                                        <tbody class="text-start">
                                            <tr>
                                                ...
                                                <td>Proof of Indian Enterprise</td>
                                                <td class="text-center"><span class="badge bg-success text-white">Submitted</span></td>
                                                <td class="text-center">
                                                    <button class="btn btn-sm btn-success" title="Upload Certification Proof" data-bs-toggle="tooltip">
                                                        <i class="fas fa-upload"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-danger" title="Request Compliance Support" data-bs-toggle="tooltip">
                                                        <i class="fas fa-phone"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-primary" title="View Compliance Support" data-bs-toggle="tooltip">
                                            ...
                                            <tr>
                                                ...
                                                <td>Quality Management Compliance</td>
                                                <td class="text-center"><span class="badge bg-danger text-white">UnSubmitted</span></td>
                                                <td class="text-center">
                                                    <button class="btn btn-sm btn-success" title="Upload Certification Proof" data-bs-toggle="tooltip">
                                                        <i class="fas fa-upload"></i>
                                                    </button>
