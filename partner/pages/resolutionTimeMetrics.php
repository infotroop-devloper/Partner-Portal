                            ...
                            <div class="card border-left-danger shadow h-100 py-2" style="height: 1">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">
                                                Tickets Resolved Within SLA</div>
                                            <span id="newRequestCount"
                                                class="fs-2hx fw-bold text-gray-800 me-2 lh-1">0</span>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-danger shadow h-100 py-2" style="height: 1">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">
                                                Tickets Resolved Outside SLA</div>
                                            <span id="newRequestCount"
                                                class="fs-2hx fw-bold text-gray-800 me-2 lh-1">0</span>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <table id="kt_datatable_vertical_scroll"
                                        ...
                                        <thead>
                                            <tr class="fw-bold text-muted bg-light">
                                                ...
                                                <th>Max Resolution Time</th>
                                                <th>Min Resolution Time</th>
                                                <th>Actions</th>
                                            </tr>
                                        </thead>
                                        <!--end::Table head-->
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-sm btn-primary" title="Escalate Tickets with High Resolution Time"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-paper-plane"></i>Escalate Tickets
                                                    </button>
                                                    <button class="btn btn-sm btn-primary" title="Flag Tickets to Management"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-flag"></i>Flag Tickets
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr>
