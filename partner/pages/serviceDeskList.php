                            ...
                            <div class="card mb-5 mb-xl-10">
								...
								<div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
									...
									<div class="card-title m-0">
										<h3 class="fw-bold m-0">Service Requests</h3>
									</div>
									<!--end::Card title-->
								</div>
								<!--begin::Card header-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												<thead>
													<tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-250px">Request ID</th>
														<th class="min-w-300px">Customer name</th>
														<th class="min-w-300px">Company Name</th>
														<th class="min-w-300px">Service Type</th>
														<th class="min-w-200px">Status</th>
														<th class="min-w-200px">Requested Date</th>
														<th class="min-w-200px">Last Updated Date</th>
                ...
                if(data.status=="success"){
					...
					for(var i =0;i<jsonObj.length;i++){						
						rowHTML = rowHTML + `<tr>
							...
							<td>
								<span style="color:#1b84ff;">`+jsonObj[i].request_id+`</span>
							</td>
							<td>
							...
							<td>
								`+jsonObj[i].service_type+`
							</td>
							<td>
								`+jsonObj[i].status+`
							</td>
							<td>
								`+jsonObj[i].request_date+`
							</td>
							<td>
								`+jsonObj[i].last_updates+`
							</td>
							<td>
								<a href="<?php echo BASE_URL;?>pages/viewServiceDeskRequest.php?id=`+jsonObj[i].id+`" title="Edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
								...
								<a href="<?php echo BASE_URL;?>pages/EditServiceDeskRequest.php?id=`+jsonObj[i].id+`" title="Edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
