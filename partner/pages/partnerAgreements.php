                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold fs-3 mb-1">Partner Agreements</span>
                                </h3>
                                <div class="card-toolbar g-2">
                                    ...
                                    <div>
                                        <select id="docType" class="form-select">
                                            ...
                                            <option value="Memorandum of Understanding">Memorandum of Understanding
                                                (MOU)</option>
                                            <option value="Non-Disclosure Agreement">Non-Disclosure Agreement (NDA)
                                            </option>
                                            <option value="Service Level Agreement">Service Level Agreement (SLA)
                                            </option>
                                            <option value="Exclusive Distribution Agreements">Exclusive Distribution
                                                Agreements</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <table id="kt_datatable_vertical_scroll"
                                        ...
                                        <thead>
                                            <tr class="fw-bold text-muted bg-light">
                                                <th class="ps-4">Agreement Name</th>
                                                <th>Partner Name</th>
                                                <th>Signed Date</th>
                                                <th>Expiry Date</th>
                                                <th>Document Type</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                                                        data-bs-target="#viewModal" title="View Agreement">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe
                    src="https://images.template.net/wp-content/uploads/2016/06/28051254/Basic-non-disclosure-agreement.jpg"
