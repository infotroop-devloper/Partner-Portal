										...
										<div class="card-body border-top p-9">
												...
												<div class="col-lg-8">
													...
													<div class="row">
														...
														<div class="col-lg-12 fv-row">
															<input type="text" name="customer_name" id="customer_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name" />
														</div>
														<!--end::Col-->
                                            ...
                                            <div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
                                                    <input type="tel" name="email_id" id="email_id" class="form-control form-control-lg form-control-solid" readonly placeholder="Email-Id" />
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<input type="tel" name="phone_no" id="phone_no" class="form-control form-control-lg form-control-solid" readonly placeholder="Phone number" />
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="text" name="address1" id="address1" class="form-control form-control-lg form-control-solid" placeholder="Address 1"  required />
												</div>
												<!--end::Col-->
											</div>
                                            ...
                                            <div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="text" name="address2" id="address2" class="form-control form-control-lg form-control-solid" placeholder="Address 2" />
												</div>
												<!--end::Col-->
											</div>
                                            ...
                                            <div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="text" name="state" id="state" class="form-control form-control-lg form-control-solid" placeholder="State" />
												</div>
												<!--end::Col-->
											</div>
                                            ...
                                            <div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="text" name="zipcode" id="zipcode" class="form-control form-control-lg form-control-solid" placeholder="Zipcode" />
												</div>
												<!--end::Col-->
											</div>
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="text" name="country" id="country" class="form-control form-control-lg form-control-solid" placeholder="Country" />
												</div>
												<!--end::Col-->
											</div>
											...
											<div class="row mb-6">
												<!--begin::Label-->
												<label class="col-lg-4 col-form-label fw-semibold fs-6">Licence-Id</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="text" name="licence_id" id="licence_id" class="form-control form-control-lg form-control-solid" placeholder="Licence-Id" />
												</div>
												<!--end::Col-->
											</div>
											...
											<div class="row mb-6">
												<!--begin::Label-->
												<label class="col-lg-4 col-form-label fw-semibold fs-6">Subscription Status</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="text" name="subscription_status" id="subscription_status" class="form-control form-control-lg form-control-solid" placeholder="Subscription Status" />
												</div>
												<!--end::Col-->
											</div>
            ...
            try {
                ...
                if(data.status=="success"){
					...
					if(jsonObj.length>0){
						...
						$("#id").val(jsonObj.id);
						$("#landline").val(jsonObj.landline);
						$("#licence_id").val(jsonObj.licence_id);
						$("#partner_idfk").val(jsonObj.partner_idfk);
						$("#phone_no").val(jsonObj.phone_no);
						$("#state").val(jsonObj.state);
						$("#subscription_status").val(jsonObj.subscription_status);
