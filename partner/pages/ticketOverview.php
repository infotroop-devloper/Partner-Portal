        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl"
                ...
                <div class="content flex-row-fluid" id="kt_content">
                                ...
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <div class="row no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <span id="newRequestCount" class="fs-2hx fw-bold text-gray-800 me-2 lh-1">0
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-3 mb-4">
                            <div class="card border-left-primary shadow py-2" style="height: 150px">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col-auto">
                                        <i class="fas fa-clipboard-list fs-3x text-gray-300"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <span class="card-label fw-bold text-gray-900 fs-2" style="margin-left:10px;">Ticket Trends</span>
                    <div class="row my-4">
                            ...
                            <div class="card-header border-0 pt-5">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end mb-4">
                                        <label class="me-2 align-self-center fs-5 fw-bold">Tickets Count:
                            ...
                            <div class="card-body py-3">
                                <div class="table-responsive">
                                    <table id="kt_datatable_vertical_scroll"
                                        class="table text-center align-middle gs-0 gy-4 fw-bold">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-primary" title="Edit or Update" data-bs-toggle="tooltip">
                                                        <i class="fas fa-pen"></i> Edit
                                                    </button>
                                                    <button class="btn btn-sm btn-primary" title="Add Notes" data-bs-toggle="tooltip">
                                                        <i class="fas fa-edit"></i> Note
                                                    </button>
                                                    <button class="btn btn-sm btn-primary" title="Excalate" data-bs-toggle="tooltip">
                                                        <i class="fas fa-user-graduate"></i> Excalate
                                                    </button>
                                                    <button class="btn btn-sm btn-primary" title="Mark As Resolved" data-bs-toggle="tooltip">
