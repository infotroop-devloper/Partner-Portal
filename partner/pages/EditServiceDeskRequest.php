...
?>
								...
								<div id="kt_account_settings_profile_details" class="collapse show">
									...
									<div id="kt_account_profile_details_form" class="form">
										...
										<div class="card-body border-top p-9">
											...
											<input type="hidden" id="partner_idfk" name="customer_idfk"/>
											<!--end::Input group-->
											<!--begin::Input group-->
											<div class="row mb-6">
												<!--begin::Label-->
                                            ...
                                            <div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="text" name="service_type" id="service_type" class="form-control form-control-lg form-control-solid" placeholder="Service Type" />
												</div>
												<!--end::Col-->
											</div>
                                            ...
                                            <div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
                                                    <input type="text" name="status" id="status" class="form-control form-control-lg form-control-solid" placeholder="Status" />
												</div>
												<!--end::Col-->
											</div>
											<!--end::Input group-->
    ...
    function saveMyProfile(){
        ...
        var postData = {
            ...
            id:$("#id").val(),
            customer_idfk:$("#customer_idfk").val(),
