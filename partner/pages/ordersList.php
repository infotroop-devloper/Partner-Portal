                            ...
                            <div class="card border-left-danger shadow py-2" style="height: 150px">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    <div class="row no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">
                                                New Orders (This week)</div>
                                            <span id="newRequestCount" class="fs-2hx fw-bold text-gray-800 me-2 lh-1">1</span>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="fas fa-box fs-3x text-gray-300"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-3 mb-4">
                            <div class="card border-left-danger shadow py-2" style="height: 150px">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col-auto">
                                        <i class="fas fa-box-open fs-3x text-gray-300"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-3 mb-4">
                            <div class="card border-left-primary shadow py-2" style="height: 150px">
                                <div class="card-body d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col-auto">
                                        <i class="fas fa-truck-loading fs-3x text-gray-300"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table id="kt_datatable_vertical_scroll"
                                        ...
                                        <tbody class="text-center">
                                            <tr>
                                                ...
                                                <td>abc</td>
                                                <td>
                                                    <button class="btn-primary btn btn-sm" title="View"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-eye my-0"></i>
                                                    </button>
                                                    <button class="btn-success btn btn-sm" title="Edit"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-pen my-0"></i>
                                                    </button>
                                                    <button class="btn-danger btn btn-sm" title="Cancle"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-times-circle my-0"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr>
