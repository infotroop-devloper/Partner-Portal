                    ...
                    <div class="card">
                        ...
                        <div class="card-body px-10 px-lg-20 pt-17 pb-10" style="padding-top: 0px !important;">
                            ...
                            <div class="table-responsive">
                                <!--begin::Table-->
                                <table class="table table-bordered gy-7" id="example">
                                    <!--begin::Table head-->
                                    <thead class="align-middle">
                                        <tr id="kt_pricing">
                                            ...
                                            <th class=" mb-15 text-center bg-primary card-rounded "
                                                style="width: 250px !important;">


                                                <div class="text-white fs-3 fw-bold mb-7">Business Consultant</div>
                                                <div
                                                    class="fs-5x text-white d-flex justify-content-center align-items-start">
                                                    <span class="fs-2 mt-3"
                                                        style="font-size: 18px !important;margin-top: 3px !important;">₹</span>
                                                    <span class="lh-sm fw-semibold" style="font-size: 34px !important;"
                                                        data-kt-plan-price-month="10000"
                                                        data-kt-plan-price-annual="10000">0</span>
                                                </div>
                                                <div class="text-white fw-bold mb-7">Lifetime</div>
                                                <a href="#"
                                                    class="btn bg-white bg-opacity-20 bg-hover-white text-hover-primary text-white fw-bold mx-auto">Current
                                                    Plan</a>
                                            </th>
