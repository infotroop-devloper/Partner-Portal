                                    ...
                                    <table id="kt_datatable_vertical_scroll"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-primary" data-bs-toggle="title"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">New Partner Registration</h1>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button fw-bold" type="button" data-bs-toggle="collapse"
                                        ...
                                        1. Company Information Submission 
                                    </button>
                                </h2>
                                <div id="collapseOne" class="accordion-show collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <input class="form-control mb-3 fw-bold" name="Business Name" type="text"
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button collapsed fw-bold" type="button"
                                        ...
                                        2. Make in India Eligibility Proof 
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                    data-bs-parent="#partnerFormAccordion">
                                    <div class="accordion-body">
                                        <label class="form-label">DPIIT Recognition <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control mb-3" name="business_license" type="file">

                                        <label class="form-label">MSME Registration <span class="text-danger">*</span></label>
