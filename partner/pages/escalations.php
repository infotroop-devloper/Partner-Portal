                            ...
                            <div class="card border-left-danger shadow h-100 py-2" style="height: 1">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">
                                                Customer Dissatisfaction</div>
                                            <span id="newRequestCount"
                                                class="fs-2hx fw-bold text-gray-800 me-2 lh-1">0</span>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-calendar-minus fs-3x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table id="kt_datatable_vertical_scroll"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Any</td>
                                                <td>Sarvesh</td>
                                                <td><span class="badge text-white bg-primary">Open</span></td>
                                                <td>[date]</td>
                                                <td>
                                                    <button class="btn btn-sm btn-primary" title="View Escalation Details"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-eye"></i>View Escalation
                                                    </button>
                                                    <button class="btn btn-sm btn-primary" title="Escalate to Higher Management"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-paper-plane"></i>Escalate Tickets
                                                    </button>
                                                    <button class="btn btn-sm btn-primary" title="Provide Customer Update"
                                                        data-bs-toggle="tooltip">
                                                        <i class="fas fa-message"></i>Update Customer
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr>
