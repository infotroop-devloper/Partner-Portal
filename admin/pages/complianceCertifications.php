                                ...
                                <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                    <div class="mb-4 px-9">
                                        ...
                                        <span class="fs-2 fw-semibold text-gray-500"
                                            style="color:white !important;">Total Partners Certified</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-header pt-5">
                                    <div class="card-title d-flex flex-column">
                                        ...
                                        <span class="text-gray-500 pt-1 fw-semibold fs-2"
                                            style="color:white !important;">Pending Certifications</span>
                                    </div>
                                </div>
                            ...
                            <div class="card overflow-hidden mb-5 mb-xl-10"
                                ...
                                <div class="card-body d-flex justify-content-between flex-column px-0 pb-0">
                                    <div class="mb-4 px-9">
                                        ...
                                        <span class="fs-2 fw-semibold text-gray-500"
                                            style="color:white !important;">Average Certification Completion
                                            Time:</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold fs-3 mb-1">Required Certifications</span>
                                </h3>
                                    ...
                                    <table id="kt_datatable_vertical_scroll"
                                        ...
                                        <thead>
                                            <tr class="fw-bold text-muted bg-light">
                                                ...
                                                <th>Certification Type Description</th>
                                                <th>Description</th>
