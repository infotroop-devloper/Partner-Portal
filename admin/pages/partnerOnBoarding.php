                                ...
                                <div class="stepper-nav">
                                    ...
                                    <div class="stepper-item" data-kt-stepper-element="nav">
                                        ...
                                        <div class="stepper-wrapper">
                                            ...
                                            <div class="stepper-label">
                                                ...
                                                <div class="stepper-desc fw-semibold">Setup Your Business Info</div>
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Wrapper-->
                                    ...
                                    <div class="stepper-item" data-kt-stepper-element="nav">
                                        ...
                                        <div class="stepper-wrapper">
                                            ...
                                            <!--begin::Label-->
                                            <div class="stepper-label">
                                                <h3 class="stepper-title">Program Compliance</h3>
                                                <div class="stepper-desc fw-semibold">Check program terms and conditions
                                                </div>
                                            </div>
                                            <!--end::Label-->
                                        </div>
                            ...
                            <div class="card-body py-20 w-100 mw-xl-700px px-9" novalidate="novalidate"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <label
                                                        ...
                                                        <span class="d-block fw-semibold text-start">
                                                            <span
                                                                class="text-gray-900 fw-bold d-block fs-4 mb-2">Reseller</span>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <label
                                                        ...
                                                        <span class="d-block fw-semibold text-start">
                                                            <span
                                                                class="text-gray-900 fw-bold d-block fs-4 mb-2">MSP</span>
                                                            <span class="text-muted fw-semibold fs-6">Managed Service
                                                                Provider</span>
                                                        </span>
                                                        <!--end::Info-->
                                                    </label>
                                                ...
                                                <div class="col-lg-12" style="margin-top: 35px;">
                                                    ...
                                                    <label
                                                        ...
                                                        <span class="d-block fw-semibold text-start">
                                                            <span
                                                                class="text-gray-900 fw-bold d-block fs-4 mb-2">CSP</span>
                                                            <span class="text-muted fw-semibold fs-6">Cloud Security
                                                                Provider</span>
                                                        </span>
                                                        <!--end::Info-->
                                                    </label>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="partner_name" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>

                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">Company locally know as</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="local_company_name" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>

                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">Head of the Company</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="company_head" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="email_id" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">Company Website / URL</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="website_url" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="pan" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>

                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">GST No.</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="gst" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="file" class="form-control form-control-lg form-control-solid"
                                                name="gst_certificate" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>

                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">Member or subsidiary of a global organization
                                                or a Dell Global Alliances partner?</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <div
                                                class="form-check form-check-solid form-switch form-check-custom fv-row">
                                                <input class="form-check-input w-45px h-30px" type="checkbox"
                                                    id="is_subsidiary" name="is_subsidiary" checked="checked">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="subsidary_company_name" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="address_line1" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="address_line2" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="zipcode" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>

                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">Upload Reseller Certificate (if
                                                applicable)</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="file" class="form-control form-control-lg form-control-solid"
                                                name="reseller_certificate" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">Upload your Legal Address documents</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="file" class="form-control form-control-lg form-control-solid"
                                                name="address_document" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="full_name" placeholder="" value="" />
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">Corporate Email</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="corporate_email" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            ...
                                            <!--begin::Input-->
                                            <input type="tel" class="form-control form-control-lg form-control-solid"
                                                name="primary_phone" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">Mobile No.</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="tel" class="form-control form-control-lg form-control-solid"
                                                name="primary_mobile" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">Job Function</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="job_function" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="form-label mb-3">Job Function Role</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-lg form-control-solid"
                                                name="job_function_role" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::Wrapper-->
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        <!--begin::Heading-->
                                        <!-- <div class="pb-10 pb-lg-15">
													<h2 class="fw-bold text-gray-900">Program Compliance</h2>
													<div class="text-muted fw-semibold fs-6">If you need more info, please check out 
                                        ...
                                        <div class="fv-row mb-10">
                                            <input type="checkbox" placeholder="" name="total_revenue" value="" /> I
                                            agree and accept the terms and conditions in the Infotroop IT Solutions
                                            Partner Program Agreement including Trade compliance requirements.
                                        </div>

                                        <div class="fv-row mb-10">
                                            <input type="checkbox" placeholder="" name="total_revenue" value="" /> I
                                            understand that to receive the benefits of the Dell Technologies Partner
                                            Program and to remain a registered partner in the Program, I must comply
                                            with the program's Terms and Conditions and fulfill at least the minimum
                                            certification requirements.
                                        </div>

                                        <div class="fv-row mb-10">
                                            <input type="checkbox" placeholder="" name="total_revenue" value="" /> I
                                            agree and accept the Dell Technologies Partner Code of Conduct.
                                        </div>

                                        <div class="fv-row mb-10" style="margin-bottom: 8px !important;">
                                            <input type="checkbox" placeholder="" name="total_revenue" value="" /> Does
                                            your company provide bribes to government officials?
                                        </div>

                                        <div class="fv-row mb-10">
                                            <input type="checkbox" placeholder="" name="total_revenue" value="" />
                                            During the past 7 years, have your company, your company affiliates, or any
                                            company shareholders, principals, directors, or key employees (current or
                                            former) been.
                                            <br /><input type="checkbox" placeholder="" name="total_revenue" value="" />
                                            Suspended or debarred from any public procurement, including any government
                                            or public organization, such as the World Bank
                                            <br /><input type="checkbox" placeholder="" name="total_revenue" value="" />
                                            Subject to government investigation, inquiry, or enforcement proceeding
                                            regarding any violation or alleged violation of any anti-bribery or
                                            anti-corruption law
                                            <br /><input type="checkbox" placeholder="" name="total_revenue" value="" />
                                            Charged, subject to allegation, or convicted of improper business conduct,
                                            such as bribery or corruption
                                            <br /><input type="checkbox" placeholder="" name="total_revenue" value="" />
                                            Terminated or suspended by Infotroop or any of its affiliates or
                                            subsidiaries
                                            <br /><input type="checkbox" placeholder="" name="total_revenue" value="" />
                                            Involved in any other concern regarding ethical business practices or
                                            reputation for honest and lawful business dealings
                                            <br /><input type="checkbox" placeholder="" name="total_revenue" value="" />
                                            None
                                        </div>
                                                ...
                                                <div class="d-flex flex-stack flex-grow-1">
                                                    ...
                                                    <div class="fw-semibold">
                                                        ...
                                                        <div class="fs-6 text-gray-700">
                                                            We have received your application to participate in the Dell
                                                            Technologies Partner Program.<br>
                                                            Your Application Number is <b>PR004669858</b>.<br>
                                                            We strive to process your request within 3-5 business days.
                                                            You may be contacted to provide additional documentation or
                                ...
                                <div class="d-flex flex-stack pt-10">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-lg btn-primary me-3"
                                            data-kt-stepper-action="submit" onClick="fnCreatePartner()">
                                        ...
                                        <div class="mh-300px scroll-y me-n7 pe-7">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="<?php echo BASE_URL; ?>assets/media/avatars/300-6.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-5">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="<?php echo BASE_URL; ?>/assets/media/avatars/300-5.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-5">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="<?php echo BASE_URL; ?>/assets/media/avatars/300-25.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-5">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="<?php echo BASE_URL; ?>/assets/media/avatars/300-9.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-5">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="<?php echo BASE_URL; ?>/assets/media/avatars/300-23.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-5">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="<?php echo BASE_URL; ?>/assets/media/avatars/300-12.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-5">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="<?php echo BASE_URL; ?>/assets/media/avatars/300-13.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-5">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle">
                                                        <img alt="Pic"
                                                            src="<?php echo BASE_URL; ?>/assets/media/avatars/300-21.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                                    <div class="ms-5">
                                        ...
                                        <div class="mh-300px scroll-y me-n7 pe-7">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-35px">
                                                        <img src="<?php echo BASE_URL; ?>/assets/media/svg/files/pdf.svg"
                                                            alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="<?php echo BASE_URL; ?>/assets/media/svg/files/doc.svg"
                                                            alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="<?php echo BASE_URL; ?>/assets/media/svg/files/css.svg"
                                                            alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="<?php echo BASE_URL; ?>/assets/media/svg/files/ai.svg"
                                                            alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                                            ...
                                            <div class="d-flex flex-stack py-4">
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px">
                                                        <img src="<?php echo BASE_URL; ?>/assets/media/svg/files/tif.svg"
                                                            alt="icon" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Details-->
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="text-center px-4">
                                        <img src="<?php echo BASE_URL; ?>/assets/media/illustrations/sketchy-1/9.png"
                    ...
                    <div class="py-5">
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="<?php echo BASE_URL; ?>/assets/media/illustrations/sketchy-1/1.png" alt=""
