                ...
                if (e) {
                    var t, a = function() {
                        ...
                        o.get("renderer").grid.template.setAll({
                            ...
                            fontSize: 13,
                            fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))
                        }), i("Hardware", "cars", KTUtil.getCssVariableValue("--bs-primary")), i("Software", "motorcycles", KTUtil.getCssVariableValue("--bs-success")), i("Business Applications", "bicycles", KTUtil.getCssVariableValue("--bs-warning")), a.set("scrollbarX", am5.Scrollbar.new(t, {
                    ...
                    var t, a = function() {
                        ...
                        var a = t.container.children.push(am5xy.XYChart.new(t, {
                            ...
                            l = (a.get("colors"), [{
                                ...
                                country: "Cisco Routers and Switches",
                                visits: 602,
                                ...
                                columnSettings: {
                                    fill: am5.color(0xce7e00)
                                }
                            }, {
                                country: "Norton & McAfee Antivirus",
                                visits: 165,
                                icon: "https://www.amcharts.com/wp-content/uploads/flags/italy.svg",
                                columnSettings: {
                                    fill: am5.color(0xd1e7c8)
                                }
                            }, {
                                country: "AWS & Azure Clouds",
                                visits: 152,
                                icon: "https://www.amcharts.com/wp-content/uploads/flags/russia.svg",
                                columnSettings: {
                                    fill: am5.color(0xf1c232)
                                }
                            }, {
                                country: "Oracle & MYSQL",
                                visits: 125,
...
var KTChartsWidget17 = {
    init: function() {
        ! function() {
            if ("undefined" != typeof am5) {
                var e = document.getElementById("kt_charts_widget_17_chart1");
                if (e) {
                    var t, a = function() {
                        (t = am5.Root.new(e)).setThemes([am5themes_Animated.new(t)]);
            ...
            if (t) {
                var a = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    l = {
                        ...
                        colors: ["#3E97FF", "#3E97FF", "#3E97FF", "#3E97FF", "#3E97FF", "#3E97FF", "#3E97FF"],
                        xaxis: {
                            categories: ["Servers", "Laptops", "Storage", "Firewalls", "Network Rack", "CRM SW", "CAD Licence"],
                            labels: {
                                formatter: function(e) {
                                    return e + "K"
                                },
